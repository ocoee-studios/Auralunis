...
### Camera (Sky Lens)
The camera is used only while Sky Lens is open, to overlay stars, planets, and
constellations onto your real sky view. No camera frames are stored, transmitted,
or analyzed unless you explicitly choose to capture and save an image.
...
Accelerometer and magnetometer readings are used to align the Sky Lens camera
overlay with the direction your phone is pointing. Sensor data is processed
...
local data. If you use iCloud Keychain or device backup, the encryption key may
persist in your backup until you remove it.
...
We may update this policy to reflect new features. The "Last updated" date at
