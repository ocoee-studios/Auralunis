...
- [ ] Name target `ChronauraWatch`
- [ ] Choose SwiftUI and Swift
- [ ] Associate it with the Chronaura iOS companion app
- [ ] Enable Widget Extension if building Smart Stack / complication surfaces now

## Add watch source
- [ ] Copy `apple-native/watchOS/ChronauraWatch/`
- [ ] Add files to the `ChronauraWatch` target membership
...
- [ ] Copy `apple-native/iOS/ChronauraWatchSync/`
- [ ] Add files to the iOS app target membership
- [ ] Register the Expo module
- [ ] Call `syncChronauraWatch(...)` when current sky summary changes
