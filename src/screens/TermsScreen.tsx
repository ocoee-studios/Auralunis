...
export function TermsScreen() {
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <Text style={styles.body}>
        AuraLunis is a premium interactive astronomy app that transforms your iPhone into a living celestial instrument. Features include an AR sky overlay, satellite tracking, constellation charts, astrophotography planning, and an Apple Watch companion. Your observations stay on your device.
      </Text>
      ...
      <Text style={styles.body}>
        ...
        Premium ($6.99/month or $39.99/year): Full Sky Lens AR, 88 constellations, all satellites, Birth Sky, Astro Weather, Astrophotography Planner, Cultural Sky Stories, Watch companion, Night Vision, Dark Sky Finder, encrypted vault.{"\n\n"}
      ...
      <Text style={styles.heading}>Free Trial</Text>
      <Text style={styles.body}>
        If a free trial is offered, the unused portion of the trial is forfeited when you purchase a subscription.
      </Text>
