...
const styles = StyleSheet.create({
  ...
  planCardSelected: { borderColor: ChronauraColors.gold, backgroundColor: "rgba(212,175,55,0.1)" },
  ...
  badge: { backgroundColor: "rgba(212,175,55,0.2)", borderRadius: 5, paddingHorizontal: 6, paddingVertical: 2 },
