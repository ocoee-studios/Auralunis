...
const s = StyleSheet.create({
  ...
  title: { color: AuraLunisColors.gold2, fontSize: 14, fontWeight: "900", marginBottom: 10 },
  header: { flexDirection: "row" },
  dow: { flex: 1, textAlign: "center", color: AuraLunisColors.muted, fontSize: 10, fontWeight: "700", marginBottom: 6 },
  grid: { flexDirection: "row", flexWrap: "wrap" },
  cell: { width: "14.28%", alignItems: "center", paddingVertical: 6 },
  moon: { width: 22, height: 22, borderRadius: 11, backgroundColor: AuraLunisColors.silver },
  dayNum: { color: AuraLunisColors.muted, fontSize: 9, marginTop: 2 }
});
