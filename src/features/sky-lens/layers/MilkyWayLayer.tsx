    ...
    <G transform={`translate(0 ${driftY.toFixed(2)})`}>
      <Defs>
        ...
        <RadialGradient id="mwGlow" cx="50%" cy="50%" r="50%">
          <Stop offset="0%" stopColor="#C4CCE0" stopOpacity={o(0.1)} />
          <Stop offset="50%" stopColor="#9AA6C4" stopOpacity={o(0.05)} />
        ...
        <RadialGradient id="mwStarCloud" cx="50%" cy="50%" r="50%">
          <Stop offset="0%" stopColor="#F2F0E6" stopOpacity={o(0.17)} />
          <Stop offset="45%" stopColor="#E6E4DA" stopOpacity={o(0.08)} />
        ...
        <RadialGradient id="mwDust" cx="50%" cy="50%" r="50%">
          <Stop offset="0%" stopColor="#030510" stopOpacity={Math.min(0.7, 0.99 * boost)} />
          <Stop offset="54%" stopColor="#040712" stopOpacity={Math.min(0.55, 0.82 * boost)} />
