      ...
      <ScrollView style={s.root} contentContainerStyle={s.content}>
        ...
        {step === 3 && (
          <View style={s.showcase}>
            <Text style={s.stepEyebrow}>EXPLORE CHRONAURA</Text>
...
const s = StyleSheet.create({
  ...
  welcome: { color: ChronauraColors.gold2, fontSize: 28, letterSpacing: 4, fontWeight: "900", marginTop: 20 },
  tagline: { fontStyle: "italic", color: ChronauraColors.silver, fontSize: 15, marginTop: 8 },
  descriptor: { color: ChronauraColors.muted, fontSize: 9, letterSpacing: 3, marginTop: 8 },
  bodyText: { color: ChronauraColors.silver, fontSize: 14, lineHeight: 22, textAlign: "center", marginTop: 20, maxWidth: 300 },
  stepEyebrow: { color: ChronauraColors.gold, fontSize: 10, letterSpacing: 2, fontWeight: "900" },
  ...
  skipText: { color: ChronauraColors.gold2, fontWeight: "800", fontSize: 13, marginTop: 16 },
  ...
  revealCore: { width: 48, height: 48, borderRadius: 24, backgroundColor: ChronauraColors.gold },
  cta: { width: "100%", borderRadius: 15, backgroundColor: ChronauraColors.gold, paddingVertical: 15, alignItems: "center", marginTop: 24 },
  ...
  secondaryCtaText: { color: ChronauraColors.gold2, fontWeight: "800", fontSize: 14 },
  showcase: { width: "100%" },
  ...
  cardLabel: { color: ChronauraColors.gold, fontSize: 9, letterSpacing: 1.5, fontWeight: "900", marginBottom: 4 },
  cardTitle: { color: "#FFF", fontSize: 16, fontWeight: "900" },
  cardBody: { color: ChronauraColors.silver, fontSize: 12.5, lineHeight: 18, marginTop: 4 }
});
